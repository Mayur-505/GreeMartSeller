          ...
          <div className="flex gap-[30px] mt-[30px]">
            ...
            <div className="max-w-[883px] w-full">
              <Accordion
                ...
                collapsible
                defaultValue="item-1"
                className="w-full border-[1px] border-solid border-[#00000033] rounded-ss-[5px] rounded-se-[5px] overflow-hidden"
              >
                <AccordionItem
                  value="item-2"
                  className=" py-[15px] px-[40px] bg-[#F9F9F9]"
                >
                ...
                <AccordionItem
                  value="item-1"
                  className="border-none px-[40px] py-[15px] bg-[#FFF]"
                >
                  <AccordionTrigger className="justify-end flex-row-reverse gap-[10px] p-0 font-Poppins text-[15px] font-[500] leading-[normal] tracking-[0.3px]">
                    <RadioGroup
                  ...
                  <AccordionContent className="px-[35px] !pb-0">
                    ...
                    >
                      <AccordionItem value="item-1" className="border-none">
                        <AccordionTrigger className="justify-end flex-row-reverse gap-[10px] p-0 my-[5px] font-Poppins text-[15px] font-[500] leading-[normal] tracking-[0.3px]">
                          Select category
                        </AccordionTrigger>
                        <AccordionContent className="px-[23px] !pb-0">
                          <Accordion
                            type="single"
                            collapsible
                            className="w-full"
